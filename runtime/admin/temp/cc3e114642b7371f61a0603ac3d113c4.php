<?php /*a:1:{s:53:"/home/vagrant/Code/tp/app/admin/view/index/index.html";i:1576151208;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="/static/admin/index.html">X-admin v2.2</a></div>
            <div class="left_open">
            ...
            <ul class="layui-nav right" lay-filter="">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="/static/admin/login.html">退出</a></dd>
                    </dl>
                </li>
